...
func (s *SQLiteRepository) initMorph(dryRun bool, timeoutSeconds int) (*morph.Morph, error) {
...
func (s *SQLiteRepository) Migrate(direction Direction, dryRun bool) error {
